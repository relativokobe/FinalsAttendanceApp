...
import com.example.asus.finalsattendanceapp.Student.StudentUpComingClassListAdapter;
...
public class Ontime extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view =  inflater.inflate(R.layout.fragment_ontime, container, false);
        ...
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                adapter = new OnTimeAdapter(userList,view.getContext());
